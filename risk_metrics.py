...
value series. Used by calculate_sharpe.py and the per-window analysis. These
metrics need NO new model calls — they reconstruct from the daily adjusted-close
path while share counts are held fixed over the holding period.
